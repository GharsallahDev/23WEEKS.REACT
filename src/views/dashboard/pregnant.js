...
const weeksData = [
  {
        ...
        imgSrc: week3,
        title: "Week 3",
        description: "At week 3, the fertilized egg has become a tiny ball of cells, rapidly multiplying!"
      },
      {
        week: 4,
        ...
        imgSrc: week4,
        title: "Week 4",
        description: "The embryo starts implanting into the uterine lining, starting a new phase of development."
      },
      {
        week: 5,
        name: "Peas",
        imgSrc: week5,
        title: "Week 5",
        description: "Major changes are happening as the embryo starts forming the brain, spinal cord, and heart."
      },
      {
        week: 6,
        name: "Blueberry",
        imgSrc: week6,
        title: "Week 6",
        description: "Your baby's heart is now beating, and tiny buds are starting to form into arms and legs."
      },
      {
        week: 7,
        name: "Rasberry",
        imgSrc: week7,
        title: "Week 7",
        description: "Facial features are beginning to develop, along with essential organs like the lungs."
      },
      {
        week: 8,
        name: "Olive",
        imgSrc: week8,
        title: "Week 8",
        description: "The embryo has now grown significantly, and fingers and toes are starting to form!"
      },
      {
        week: 9,
        name: "Cherry",
        imgSrc: week9,
        title: "Week 9",
        description: "Your baby is looking more human! The organs are developing rapidly, and the heart has divided into four chambers."
      },
      {
        week: 10,
        name: "Lime",
        imgSrc: week10,
        title: "Week 10",
        description: "The vital organs are nearly fully formed, and your baby is now officially considered a fetus."
      },
      {
        week: 11,
        name: "Plum",
      ...
      },
      {
        ...
        imgSrc: week12,
        title: "Week 12",
        description: "Your baby’s reflexes are developing, and the intestines are moving into the abdominal cavity."
      },
      {
        week: 13,
        name: "Nectarine",
      ...
      },
      {
        ...
        imgSrc: week14,
        title: "Week 14",
        description: "Your baby’s body is lengthening, and the facial features are becoming more defined."
      },
      {
        week: 15,
        name: "Avocado",
        imgSrc: week15,
        title: "Week 15",
        description: "Your baby is practicing breathing motions and can now sense light even with eyes closed."
      },
      {
        week: 16,
        name: "Pear",
      ...
      },
      {
        ...
        imgSrc: week19,
        title: "Week 19",
        description: "The senses are becoming sharper, and your baby may start to recognize your voice."
      },
      {
        week: 20,
        name: "Sweet Potato",
      ...
      },
      {
        ...
        imgSrc: week23,
        title: "Week 23",
        description: "Your baby is practicing swallowing and will soon start to gain more weight rapidly."
      },
      {
        week: 24,
        name: "Eggplant",
      ...
      },
      {
        ...
        imgSrc: week27,
        title: "Week 27",
        description: "The third trimester begins! Your baby is getting ready for the final growth stage."
      },
      {
        week: 28,
        name: "Red Cabbage",
      ...
      },
      {
        ...
        imgSrc: week32,
        title: "Week 32",
        description: "Your baby’s lungs are nearly fully developed, and they’re getting ready for life outside."
      },
      {
        week: 33,
        name: "Buternu Squach",
        imgSrc: week33,
        title: "Week 33",
        description: "Your baby is growing larger, and their brain is developing more complex connections."
      },
      {
        week: 34,
        name: "Honey Melon",
        imgSrc: week34,
        title: "Week 34",
        description: "The immune system is getting stronger, and your baby is practicing breathing movements."
      },
      {
        week: 35,
        name: "Swiss Chard",
        imgSrc: week35,
        title: "Week 35",
        description: "Your baby is putting on more weight, preparing for birth, and the skin is becoming smoother."
      },
      {
        week: 36,
        name: "Winter Melon",
      ...
      },
      {
        ...
        imgSrc: week38,
        title: "Week 38",
        description: "All systems are almost ready! Your baby is gaining more weight and preparing for life outside."
      },
      {
        week: 39,
        name: "Watermelon",
        imgSrc: week39,
        title: "Week 39",
        description: "Your baby is finishing final preparations, and delivery could happen any day now!"
      },
      {
        week: 40,
        name: "Pumpkin",
      ...
      },
      {
        ...
        imgSrc: week41,
        title: "Week 41",
        description: "If your baby hasn’t arrived yet, they’re taking their time but still healthy and growing."
      }
...
function Pregnant() {
  ...
  <Typography
    variant="h2"
    gutterBottom
    sx={{ color: '#dd1367', fontWeight: 'bold', mb: 4, mt: 4 }}
  >
