...
export const testimonials = [
  ...
  },
  {
    ...
    comment:
      "23Weeks has been an invaluable tool in my practice. The advanced features for monitoring and reporting have significantly improved my ability to provide top-notch care to my patients.",
  },
  {
    id: '2',
    ...
    comment: "I am truly impressed with the 23Weeks solution. Its comprehensive approach to prenatal care is unmatched, and I’m proud to partner with such an innovative solution.",
  },
  {
    id: '3',
    name: 'Amina Diallo',
    role: 'Gynecologist and Expert Partner',
    avatarUrl: '../images/user-4.jpg',
    comment:
      "23Weeks has been a blessing throughout my pregnancy. The personalized care plans and symptom tracking have provided me with much-needed support and reassurance.",
  },
  // {
  //   id: '4',
  //   name: 'Becky Snider',
...
export const logos = [
  ...
  },
  {
    id: '1',
    title: 'Amplitude',
    url: '/images/logo_medsyn_solutions.png',
    width: 156,
    height: 48,
  },
  {
